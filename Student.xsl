  ...
  <body>
                ...
                <fo:region-body/>
                  ...
                  <fo:flow flow-name="xsl-region-body">
                    <fo:block font-size=14pt font-family=sans-serif font-weight=bold color=green space-before=6pt space-after=6pt>
                ...
                <fo:page-sequence master-name="my-page">
                  <fo:flow flow-name="xsl-region-body">
                    <fo:block font-size=14pt font-family=sans-serif font-weight=bold color=red space-before=6pt space-after=6pt>
